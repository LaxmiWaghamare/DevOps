...
def mainroot():
	...
	def staff():
		...
		Label(emp1inf,text="Mr.Swayam Appasha Waghamare ",bg='white',fg="Grey",font='msserif 10').place(x=60,y=37)
		Label(emp1inf,text="Extention : 025",bg='white',fg="Grey",font='msserif 10').place(x=60,y=59)
		Label(emp1inf,text="Mail : swayam081119@gmail.com",bg='white',fg="Grey",font='msserif 10').place(x=60,y=83)
